//
//  MyOrderFinishedViewController.m
//  XIONGEN
//
...
@interface MyOrderFinishedViewController () <UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
...
@implementation MyOrderFinishedViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    FollowOrderTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"orderfinish"];
    if (cell==nil) {
        cell = [[FollowOrderTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"orderfinish"];
    }
    ...
    [cell.btn_orderType setTitle:@"待确定" forState:UIControlStateNormal];
