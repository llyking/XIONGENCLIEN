...
- (void)setNavItem:(MMScanType)type {
    ...
    UIView *_topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, SafeAreaTopHeight)];
    _topView.backgroundColor = ThemeColor;
    [self.view addSubview:_topView];
    
    UILabel * _Namelab = [[UILabel alloc] initWithFrame:CGRectMake(30, StatubarHeight, kScreenWidth-45, 44)];
